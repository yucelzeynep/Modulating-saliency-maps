...
class MyObject():
    """
    MyObject is a collection of data regarding a single object (or equivalently an image).
...
#            pickle.dump(self, f, pickle.HIGHEST_PROTOCOL)
    ...
    def compute_smap_specres(self):
        ...
        if preferences.SALIENCIES['STATIC_SPECRES']:
            ...
            fig_tools.scale_and_display(saliencyMap_static_specres, "STATIC_SPECRES")
    ...
    def compute_smap_finegrain(self):
        ...
        if preferences.SALIENCIES['FINE_GRAIN']:
            ...
            fig_tools.scale_and_display(saliencyMap_static_finegrain, "FINE_GRAIN")
    ...
    def compute_smap_objectness(self):
        ...
        if preferences.SALIENCIES['OBJECTNESS']:                    
            ...
            fig_tools.scale_and_display(output, 'OBJECTNESS')
            
    def build_saliency_map(self):
        """
        Compute salinecy maps accordong to different paradigms
        Check preferences for the leys to control types of saliency
        """
    ...
    def get_fg_binary(self):
        """
        the image dispayed to the participant is gray scale. but there are 3 
        channels
        """
    ...
    def set_object_dims(self):
        ...
        lond and short sides of the object
        """
